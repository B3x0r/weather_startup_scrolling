...
const String baseAssetURL = 'https://i.giphy.com/media/';
const String headerImage = '${baseAssetURL}65u/200.gif';

const Map<int, DailyForecast> _kDummyData = {
  0: DailyForecast(
    id: 0,
    imageId: '${baseAssetURL}ySu/200.gif',
    highTemp: 73,
    lowTemp: 52,
    description:
  ...
  1: DailyForecast(
    id: 1,
    imageId: '${baseAssetURL}A48l/200.gif',
    highTemp: 70,
    lowTemp: 50,
  ...
  2: DailyForecast(
    id: 2,
    imageId: '${baseAssetURL}TH2O/200.gif',
    highTemp: 71,
    lowTemp: 55,
  ...
  3: DailyForecast(
    id: 3,
    imageId: '${baseAssetURL}7Qpb/200.gif',
    highTemp: 74,
    lowTemp: 60,
  ...
  4: DailyForecast(
    id: 4,
    imageId: '${baseAssetURL}1kve/200.gif',
    highTemp: 67,
    lowTemp: 60,
  ...
  5: DailyForecast(
    id: 5,
    imageId: '${baseAssetURL}7sdC/200.gif',
    highTemp: 73,
    lowTemp: 57,
  ...
  6: DailyForecast(
    id: 6,
    imageId: '${baseAssetURL}Iqt/200.gif',
    highTemp: 75,
    lowTemp: 58,
